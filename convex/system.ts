...
const validateInternalKey = (key: string) => {
  ...
  if (!internalKey) {
    throw new Error("CURATE_CONVEX_INTERNAL_KEY is not configured");
  }
  if (key !== internalKey) {
...
// Using for Agent conversation context
...
// Used by the agent to update the conversation title
...
// Used for Agent's ListFiles tool
